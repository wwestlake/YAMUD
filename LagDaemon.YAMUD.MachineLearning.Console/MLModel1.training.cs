...
namespace LagDaemon_YAMUD_MachineLearning_Console
{
    public partial class MLModel1
    {
        public const string RetrainFilePath =  @"D:\Projects\Models\data\Dataset_Python_Question_Answer.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"Answer",inputColumnName:@"Answer",addKeyValueAnnotationsAsText:false)      
                                    .Append(mlContext.MulticlassClassification.Trainers.TextClassification(labelColumnName: @"Answer", sentence1ColumnName: @"Question"))      
